# =============================================================
# inventory/product.py  — Charmi Bhayani (202512028)
#
# Core data model for products in the kiosk inventory.
# 'quantity_available' is intentionally NOT stored here —
# it is a DERIVED ATTRIBUTE computed by Inventory at runtime:
