# =============================================================
# inventory/persistence_manager.py  — Charmi Bhayani (202512028)
#
# Handles JSON / CSV file persistence for:
#   • Inventory snapshots  (per-kiosk JSON)
#   • Transaction history  (append-only CSV)
...
class PersistenceManager:
    """
    Reads and writes operational state to disk.

    File layout under data_dir/
    ----------------------------
    inventory_{kiosk_id}.json  — product catalogue snapshot
    transactions.csv           — append-only transaction log
