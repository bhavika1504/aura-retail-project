# =============================================================
# core/kiosk_states.py  — Devam Tanna (202512010)
# PATTERN: State
#
# KioskModeManager holds one KioskState at a time.
# Behaviour changes at runtime by swapping the state object —
# no if/elif chains anywhere in business logic.
#
# States
# ------
