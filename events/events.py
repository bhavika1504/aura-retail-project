# =============================================================
# events/events.py
# Shared event data classes used by the Observer (EventBus).
# All subsystems communicate ONLY via these event objects —
# publishers never import subscriber modules directly.
# =============================================================
