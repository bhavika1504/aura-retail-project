# =============================================================
# hardware/payment_processor.py + payment_adapters.py
# Bhavika Mulani (202512079)
# PATTERN: Adapter
#
# Problem: CardGatewayAPI, UPIVendorAPI, WalletSDK all have
#          incompatible interfaces.
# Solution: Wrap each in an Adapter that implements the single
#           PaymentProcessor interface the kiosk depends on.
#           New providers can be added without touching the kiosk.
# =============================================================
...
class UPIVendorAPI:
    ...
    def initiate_upi(self, vpa: str, rupees: float) -> str:
        print(f"[UPIVendorAPI] UPI ₹{rupees:.2f} → {vpa}")
        return "UPI_SUCCESS"
