# =============================================================
# hardware/hardware_manager.py  — Bhavika Mulani (202512079)
# PATTERN: Mediator
#
# Centralises ALL hardware communication.
# No other class ever holds a reference to a DispenserHardware,
# PaymentProcessor, or HardwareModule directly — they always
# call through HardwareManager, which mediates interactions.
#
# Also satisfies the Path B "hot-swap" constraint:
#   set_dispenser() replaces the dispenser at runtime with
...
class HardwareManager:
    ...
    Responsibilities
    ----------------
    - Manage the active DispenserHardware (swappable)
    - Route payments through the configured PaymentProcessor
    - Attach / detach optional HardwareModules dynamically
    - Invoke the Chain of Responsibility on dispense failures
    """
    ...
    # ----------------------------------------------------------
    # Internal: build the failure-handling chain
    # ----------------------------------------------------------
    @staticmethod
